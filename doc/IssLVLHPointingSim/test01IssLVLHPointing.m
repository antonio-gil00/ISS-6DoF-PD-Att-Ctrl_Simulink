%test01IssLVLHPointingSim  Test 01 for earth point sat with CMG and PD Control
%-------------------------------------------------------------------------------
% Model
...
% Controller
adcsParams.kP = -2e-5*[1 1 1];
adcsParams.kD = -2e-5*[1 1 1];
adcsParams.innerAngDistGain = 1/dtSim;
adcsParams.outerAngDistGain  = 1.8e-10;
